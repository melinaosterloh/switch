...
function create() {
    ...
    for (let i = 0; i <= anzahlBodenplatten; i++) {
        if (i == 0) {
            ...
            platforms.create(200 + (400 * i), 795 - 16, 'meadow')
            fences.create(200 + (400 * i), 740 - 16, 'fence')
            } else {
            if (Math.random() < 0.3) {
    ...
    goal = goals.create((anzahlBodenplatten-1) * 400-50, 650, 'goal');
    ziel = ziele.create((anzahlBodenplatten) * 400-60, 250, 'ziel');
...
/*    this.physics.add.collider(platforms, darkness);*/
    ...
    this.physics.add.collider(currentPlayer, goal, gewonnen, null, this);
