...
class TitleScene extends Phaser.Scene {
    ...
    preload(){
        this.load.image('background_example','assents/background.png');
        this.load.image('StartButton','assets/star.png');
    }

    create () {
        let background = this.add.sprite(0, 0, 'background_example');

        var startButton = this.add.image(this.game.renderer.width/2,
                          this.game.renderer.height/2,'StartButton').setDepth(1);
...
class playGame extends Phaser.Scene{
    ...
    function moveDarkness(speed) {
        ...
        */
/*darkness2.getChildren()[0].x = darkness2.getChildren()[0].x + speed
        darkness2.getChildren()[0].body.x = darkness2.getChildren()[0].body.x + speed*//*
...
/*    this.load.image('darkness', 'assets/darkness2.png')
        ...
        this.load.spritesheet('darkness', 'assets/darknessSprite.png', {
                frameWidth: 1464,
                frameHeight: 750
            });
...
/*    darkness2 = this.physics.add.staticGroup();
    ...
    //    createMoveAnimation(this, 'left', this.katzeModel.supermodel, 0, 2);
        ...
        */
/*this.physics.add.collider(currentPlayer, darkness2, hitDarkness, null, this);*//*

    */
/*    this.physics.add.collider(platforms, darkness);*//*
